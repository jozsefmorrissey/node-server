...
public class DebugGui {
	...
	public static DebugGui exception(String group, String errorId, Throwable error) {
		if (!debug.get())
			return instance;
		restPostCall(getUrl("exception", getId(), getGroup(group)),
				new Exception(errorId, error.getMessage(), ExceptionUtils.getStackTrace(error)));
		return instance;
	}
	...
	public static String toHtml() {
		...
		return "<script type='text/javascript' src='" + host + "js/debug-gui.js'></script><debug-gui-data url='" + host
				+ "' dg-id='" + id + "' style='display:none;'></debug-gui-data>";
	}
}
