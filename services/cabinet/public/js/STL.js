...
exports['40671914'] = (get, $t) => 
	...
	exports['-1257872823'] = (get, $t) => 
			`<tr class='color-cnt'> <td class='borderless'><input type='color'></td> <td class='color-input-tree-cnt'></td> </tr>`
	...
	exports['-1078485837'] = (get, $t) => 
			`<tr class='color-cnt'> <td class='borderless'><input type='color' value='` +
			$t.clean(get("inputTree").color()) +
			`'></td> <td class='color-input-tree-cnt'>` +
			$t.clean(get("inputTree").html()) +
			`</td> </tr>`
	
	exports['-433070821'] = (get, $t) => 
			`<tr class='color-cnt'> <td class='borderless'> <input type='color' original='` +
			$t.clean(get("inputTree").color()) +
			`' value='` +
			$t.clean(get("inputTree").color()) +
			`'> </td> <td class='color-input-tree-cnt'>` +
