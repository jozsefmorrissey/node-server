...
exports['245360901'] = (get, $t) => 
		`<span class='orig-reports' > <b>Time</b> ` +
		$t.clean(get("report").time) +
		` <b>Type:</b> ` +
		$t.clean(get("report").type) +
		` <b>Days:</b> ` +
		$t.clean(get("report").dayIndexes) +
		`<br> </span>`

exports['261019401'] = (get, $t) => 
...
exports['379175425'] = (get, $t) => 
		`<tr > <td><input type='radio' name='plan' value='` +
...
exports['383299934'] = (get, $t) => 
		`<tr > <td><input type='time'></td> <td class='toggle-cnt days'> <span sending='true' day-index='0'>S</span> <span sending='true' day-index='1'>M</span> <span sending='true' day-index='2'>T</span> <span sending='true' day-index='3'>W</span> <span sending='true' day-index='4'>T</span> <span sending='true' day-index='5'>F</span> <span sending='true' day-index='6'>S</span> </td> <td class='toggle-cnt types'> <span style="text-decoration: line-through;">Hourly</span> <span style="text-decoration: line-through;">Daily</span> <span sending='true'>Both</span> </td> </tr>`
...
exports['1524380006'] = (get, $t) => 
		`<div class='tab pointer orig-reports' > <b>Time</b> ` +
		$t.clean(get("report").time) +
		` <b>Type:</b> ` +
		$t.clean(get("report").type) +
		` <b>Days:</b> ` +
...
exports['2072039057'] = (get, $t) => 
		`<div class='left tab pointer orig-reports' > <b>Time</b> ` +
		$t.clean(get("report").time) +
		` <b>Type:</b> ` +
		$t.clean(get("report").type) +
		` <b>Days:</b> ` +
...
exports['order-form'] = (get, $t) => 
		...
		$t.clean( new $t('-1821268506').render('0..10', 'i', get)) +
...
exports['weather-reports/daily'] = (get, $t) => 
		`<!DOCTYPE html> <html lang="en" dir="ltr"> <head> <meta charset="utf-8"> <title>Daily Weather Report</title> <style> h3 {margin: 0;font-size:12pt} div {font-size: 8pt;} b {font-size: 8pt;} .icon-cnt {position: absolute; right: 0; top: 0;} .day-cnt {position: relative;} </style> </head> <body> <div> <h1>Daily Weather Report</h1> ` +
		$t.clean( new $t('-2106749180').render(get("weatherData"), 'day', get)) +
		` </div> </body> </html> `

exports['-2106749180'] = (get, $t) => 
		`<div class='day-cnt'> <h3>` +
		...
		` &#x2109;</td> </tr> </tbody> </table> <span class='icon-cnt'> ` +
		$t.clean( new $t('698669312').render(get("day").weather, 'type', get)) +
...
exports['weather-reports/hourly'] = (get, $t) => 
		`<div> <style> h3 {margin: 0;font-size:10pt} div {font-size: 8pt;} b {font-size: 8pt;} .icon-cnt {position: absolute; right: 0; top: 0;} .hour-cnt {position: relative;} </style> <div> <h1>` +
		$t.clean(get("utils").getDateStr(get("weatherData")[0].dt)) +
		` Daily Weather Report</h1> ` +
...
exports['-539708155'] = (get, $t) => 
		`<span class='orig-reports' > <b>Time</b> ` +
		$t.clean(get("report").time) +
		` <b>Type:</b> ` +
		$t.clean(get("report").type) +
		` <b>Days:</b> <z:t repeat='i in report.dayIndexes'>` +
		$t.clean(get("dayToString")(get("i"))) +
		`<br> </span>`

exports['-1754517366'] = (get, $t) => 
		`<span class='orig-reports' > <b>Time</b> ` +
		$t.clean(get("report").time) +
		` <b>Type:</b> ` +
		$t.clean(get("report").type) +
...
exports['-1751466201'] = (get, $t) => 
		`<span class='pointer orig-reports' > <b>Time</b> ` +
		$t.clean(get("report").time) +
		` <b>Type:</b> ` +
		$t.clean(get("report").type) +
		` <b>Days:</b> ` +
...
exports['-400010724'] = (get, $t) => 
		`<span class='tab pointer orig-reports' > <b>Time</b> ` +
		$t.clean(get("report").time) +
		` <b>Type:</b> ` +
		$t.clean(get("report").type) +
		` <b>Days:</b> ` +
