...
var https_options = {};
if (global.ENV !== 'local') {
  https_options.key = fs.readFileSync(shell.exec("realpath ~/.cert/jozsefmorrissey_com.key").stdout.trim(), 'utf8');
  https_options.cert = fs.readFileSync(shell.exec("realpath ~/.cert/jozsefmorrissey_com.csr").stdout.trim(), 'utf8');
