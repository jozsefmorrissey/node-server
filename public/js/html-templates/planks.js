...
$t.functions['73542142'] = function (get) {
	return `<div ` + (get("key") === 'parts' ? 'hidden' : '') + `> <div class='model-selector'> <label>` + (get("key")) + `</label> <input type='checkbox'> ` + (new $t('./public/html/planks/model-controller.html').render(get('scope'), 'key, parts in parts', get)) + ` </div> </div>`
}
...
$t.functions['1000770350'] = function (get) {
	return `<div ` + (get("key") === 'parts' ? 'hidden' : '') + `> <div class='model-selector'> <label>` + (get("label")) + `</label> <input type='checkbox'> ` + (new $t('./public/html/planks/model-controller.html').render(get('scope'), 'label in group.labels', get)) + ` </div> </div>`
}
$t.functions['1832435933'] = function (get) {
	return `<div ` + (get("key") === 'parts' ? 'hidden' : '') + `> <div class='model-selector'> <label>` + (get("label")) + `</label> <input type='checkbox'> ` + (new $t('./public/html/planks/model-controller.html').render(get('scope'), 'label in labels', get)) + ` </div> </div>`
}
...
$t.functions['./public/html/planks/model-controller.html'] = function (get) {
	return `` + (new $t('<div  {{key === \'parts\' ? \'hidden\' : \'\'}}> <div class=\'model-selector\'> <label>{{label}}</label> <input type=\'checkbox\'> {{new $t(\'./public/html/planks/model-controller.html\').render(get(\'scope\'), \'label in group.labels\', get)}} </div> </div>').render(get('scope'), 'label, group in parts', get)) + ` `
}
