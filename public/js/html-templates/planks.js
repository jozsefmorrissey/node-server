...
$t.functions['554782923'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input class='feature-radio' type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("feature").isRoot() || get("features").length === 1 ? "hidden disabled" : "") + `> <div ` + (get("feature").isRoot() || get("features").length === 1 ? '' : 'hidden') + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` <input type='text' placeholder="UniqueNotes" ` + (get("feature").isRoot() || get("features").length === 1 ? "hidden disabled" : "") + `> </div> </div>`
}
...
$t.functions['1599605982'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input class='feature-radio' type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? "hidden disabled" : "") + `> <div> <input type='text' placeholder="UniqueNotes" ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? "hidden disabled" : "") + `> <div> <div ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? '' : 'hidden') + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` </div> </div>`
}
$t.functions['1737592390'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input class='feature-radio' type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("id") === 'root' || get("features").length === 1 ? "hidden disabled" : "") + `> <div ` + (get("id") === 'root' || get("features").length === 1 ? '' : 'hidden') + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` </div> </div>`
}
$t.functions['1976759480'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input class='feature-radio' type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? "hidden disabled" : "") + `> <div ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? '' : 'hidden') + `> <input type='text' placeholder="UniqueNotes" ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? "hidden disabled" : "") + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` </div> </div>`
}
...
$t.functions['./public/html/planks/features.html'] = function (get) {
	return `<div class='tab'> ` + (new $t('<div > <label>{{feature.name}}</label> <input class=\'feature-radio\' type=\'radio\' name=\'{{id}}\' value=\'{{feature.id}}\' {{feature.isRoot(id) || features.length === 1 ? "hidden disabled" : ""}}> <div {{feature.isRoot(id) || features.length === 1 ? \'\' : \'hidden\'}}> <input type=\'text\' placeholder="Unique Notes" {{feature.isRoot(id) || features.length === 1 ? "hidden disabled" : ""}}> {{new $t(\'./public/html/planks/features.html\').render({features: get(\'feature.features\'), id: get(\'id\') + \'.\' + get(\'feature.id\')})}} </div> </div>').render(get('scope'), 'feature in features', get)) + ` </div> `
}
$t.functions['-390214478'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("id") === 'root' || get("features").length === 1 ? "hidden" : "") + `> <div ` + (get("id") === 'root' || get("features").length === 1 || get("feature").selected(get("id")) ? '' : 'hidden') + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` </div> </div>`
}
...
$t.functions['-415667541'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("id") === 'root' || get("features").length === 1 ? "hidden" : "") + `> <div ` + (get("id") === 'root' || get("features").length === 1 ? '' : 'hidden') + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` </div> </div>`
}
$t.functions['-358515546'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input class='feature-radio' type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("id") === 'root' || get("features").length === 1 ? "hidden" : "") + `> <div ` + (get("id") === 'root' || get("features").length === 1 ? '' : 'hidden') + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` </div> </div>`
}
$t.functions['-827603210'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input class='feature-radio' type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("id") === 'root' || get("features").length === 1 ? "hidden disabled" : "") + `> <div ` + (get("id") === 'root' || get("features").length === 1 ? '' : 'hidden') + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` <input type='text' placeholder="UniqueNotes"> </div> </div>`
}
$t.functions['-1980505203'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input class='feature-radio' type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("feature").isRoot() || !get("feature").multipleFeatures() ? "hidden disabled" : "") + `> <div ` + (get("feature").isRoot() || !get("feature").multipleFeatures() ? '' : 'hidden') + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` <input type='text' placeholder="UniqueNotes" ` + (get("feature").isRoot() || !get("feature").multipleFeatures() ? "hidden disabled" : "") + `> </div> </div>`
}
$t.functions['-1367095162'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input class='feature-radio' type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? "hidden disabled" : "") + `> <div ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? '' : 'hidden') + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` <input type='text' placeholder="UniqueNotes" ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? "hidden disabled" : "") + `> </div> </div>`
}
$t.functions['-1008954036'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input type='text' placeholder="UniqueNotes" ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? "hidden disabled" : "") + `> <input class='feature-radio' type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? "hidden disabled" : "") + `> <div ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? '' : 'hidden') + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` </div> </div>`
}
$t.functions['-962840316'] = function (get) {
	return `<div > <label>` + (get("feature").name) + `</label> <input class='feature-radio' type='radio' name='` + (get("id")) + `' value='` + (get("feature").id) + `' ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? "hidden disabled" : "") + `> <div ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? '' : 'hidden') + `> <input type='text' placeholder="Unique Notes" ` + (get("feature").isRoot(get("id")) || get("features").length === 1 ? "hidden disabled" : "") + `> ` + (new $t('./public/html/planks/features.html').render({features: get('feature.features'), id: get('id') + '.' + get('feature.id')})) + ` </div> </div>`
}