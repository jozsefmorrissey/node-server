...
$t.functions['12159033'] = function (get) {
	return `<div > ID: ` + (get("assem").objId) + ` ` + (get("getFeatureDisplay")(get("assem"))) + ` </div>`
}
$t.functions['50191110'] = function (get) {
	return `<div > <h3>` + (get("assem").objId) + `</h3> <div> ` + (get("getFeatureDisplay")(get("assem"))) + ` </div> </div>`
}
...
$t.functions['-1325757160'] = function (get) {
	return `<div class='section-feature-ctn'> ` + (get("getFeatureDisplay")(get("assem"))) + ` </div>`
}
$t.functions['-1056937726'] = function (get) {
	return `<div > ID: ` + (get("assem").id) + ` ` + (new $t('<div class=\'section-feature-ctn\'> {{getFeatureDisplay(assem)}} </div>').render(get('scope'), 'feature in assem.features', get)) + ` </div>`
}
...
$t.functions['-1862498822'] = function (get) {
	return `<div > <h3>` + (get("assem").objId) + `<h3> ` + (get("getFeatureDisplay")(get("assem"))) + ` </div>`
}