...
$t.functions['./public/html/planks/cabinet-head.html'] = function (get) {
	return `<div class='cabinet-header'> <input class='cabinet-input' type='id' value='` + (get("cabinet").id || get("$index")) + `'> Size: <div class='cabinet-dem-cnt'> <label>W:</label> <input class='cabinet-input dem' type='width' value='` + (get("cabinet").width()) + `'> <label>H:</label> <input class='cabinet-input dem' type='height' value='` + (get("cabinet").length()) + `'> <label>D:</label> <input class='cabinet-input dem' type='depth' value='` + (get("cabinet").thickness()) + `'> </div> H: ` + (get("cabinet").openingDemensions().length) + ` W: ` + (get("cabinet").openingDemensions().width) + ` r: ` + (get("cabinet").openingDemensions().overlap.right) + ` l: ` + (get("cabinet").openingDemensions().overlap.left) + ` t: ` + (get("cabinet").openingDemensions().overlap.top) + ` b: ` + (get("cabinet").openingDemensions().overlap.bottom) + ` </div> `
}
...
$t.functions['./public/html/planks/opening.html'] = function (get) {
	return `<div> <label>Dividers:</label> <input type="number" min="0" max="10" step="1" class='open-division-input' opening-id='` + (get("opening").uniqueId) + `' value='` + (get("opening").dividerCount()) + `'> <span class='open-orientation-radio-cnt hidden'> <label for='open-orientation-horiz-` + (get("opening").uniqueId) + `'>Horizontal:</label> <input type='radio' name='orientation-` + (get("opening").uniqueId) + `' value='horizontal' open-id='` + (get("opening").uniqueId) + `' id='open-orientation-horiz-` + (get("opening").uniqueId) + `' class='open-orientation-radio'> <label for='open-orientation-vert-` + (get("opening").uniqueId) + `'>Vertical:</label> <input type='radio' name='orientation-` + (get("opening").uniqueId) + `' value='vertical' open-id='` + (get("opening").uniqueId) + `' id='open-orientation-vert-` + (get("opening").uniqueId) + `' class='open-orientation-radio'> </span> <select class='open-pattern-select ` + ( get("opening").dividerCount() > 0 ? '' : 'hidden') + `' id='` + (get("selectPatternId")) + `' prop-update='pattern' divisions=` + (get("opening").dividerCount()) + `> ` + (get("patterns")) + ` </select> PATTERN: ` + (get("opening").pattern()) + ` || ` + (get("opening").sectionProperties()) + ` <span> ` + (get("inputHtml")) + ` </span> </div> <div id='` + (get("openDispId")) + `'> </div> `
}
